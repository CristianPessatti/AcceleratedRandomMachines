...
randomMachinesClassifier <- function(
  ...
  attr(ensemble_model, "class") <- "randomMachinesClassifierNEAfterClass"
  return(ensemble_model)
}

randomMachinesClassifierNEAfterClass <- setClass("randomMachinesClassifierNEAfterClass",
  slots = list(
    train = "data.frame",
    target = "character",
    kernels = "list",
...
predict.randomMachinesClassifierNEAfterClass <- function(rmc_model, newdata, type = "class") {
